...
def main():
    ...
    unique_users = ratings_df['Username'].unique()[:1000]
    ...
    batch_size = 256
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=1, worker_init_fn=silence_worker_output)
    test_loader = DataLoader(test_dataset, batch_size=batch_size, shuffle=False, num_workers=1, worker_init_fn=silence_worker_output)
